...
class TurnstileAuthChallengeVerifierPortImplTest {
    ...
    void should_reject_response_when_turnstile_reports_failure() {
        ...
        TurnstileAuthChallengeVerifierPortImpl verifier = new TurnstileAuthChallengeVerifierPortImpl(gateway, "localhost");
    ...
    void should_accept_response_when_turnstile_succeeds_for_allowlisted_hostname() {
        ...
        TurnstileAuthChallengeVerifierPortImpl verifier = new TurnstileAuthChallengeVerifierPortImpl(gateway, "localhost,127.0.0.1");
